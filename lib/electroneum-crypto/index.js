...
const Self = function () {
  ...
  if (!this.crypto && typeof window !== 'undefined' && typeof window.ElectroneumCrypto !== 'undefined') {
...
function loadNativeAddon () {
  ...
  try {
    Self = require('electroneum-crypto')
...
function loadNativeJS () {
  ...
  try {
    Self = require('./electroneum-crypto.js')()
    if (Object.getOwnPropertyNames(Self).length === 0) {
      throw new Error('Could not load')
    }
  } catch (e) {
